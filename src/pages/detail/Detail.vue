<template>
    <div class="container">
        ...
        <div class="contract">
            <img src="https://img3.doubanio.com/f/ark/194e1e765a170032e61aadd737d5b25c6ddca6c3/pics/common/profile/icon-contract-badge.svg">
        ...
        <div class="tig-container">
            ...
            <span class="iconfont">&#xeba0;</span>
            <span class="tigName" v-for="(item,index) in list.tigName" :key="index">{{item}}</span>
        ...
        <div class="introduce-content" v-for="(item,index) in list.introduce" :key="index">{{item}}</div>
    </div>
</template>
<script>
...
.image{
    ...
    background-image:linear-gradient(to top,#f3f3f3,rgb(0,0,0,0)), url("https://img3.doubanio.com/view/ark_column_banner/orig/public/1.jpg");
    top: 0;
    left: 0;
    z-index: -1;
    width: 100%;
...
.cleanfloat::after{display: block; clear: both; content:""; visibility: hidden; height: 0;}
 ul li{list-style:none; float:left; font-size:16px; margin:2px; color:#ccc; cursor:pointer;}
.hs{color:#f00;}
